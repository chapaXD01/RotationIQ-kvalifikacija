            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="rounded-2xl overflow-hidden shadow-xl border border-white/10 bg-white/5 backdrop-blur-md flex flex-col">
                    ...
                    <div class="p-6 flex flex-col gap-5 flex-1">
                        ...
                        {{-- Rotation Name --}}
                        <div>
                            <label for="rotation-name" class="block text-xs font-semibold uppercase tracking-widest text-blue-300/80 mb-2">
                                {{ __('Rotation Name') }}
                            </label>
                            <input
                                type="text"
                                id="rotation-name"
                                placeholder="e.g. Serve Receive #1"
                                class="w-full px-4 py-2.5 rounded-xl text-white text-sm placeholder-white/30 bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-blue-500/60 focus:border-blue-500/40 transition"
                            >
                        </div>

                        {{-- Rotation Type --}}
                        <div>
                            <label for="rotationType" class="block text-xs font-semibold uppercase tracking-widest text-blue-300/80 mb-2">
                                {{ __('Rotation Type') }}
                            </label>
                            <select
                                id="rotationType"
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <button
                                ...
                                class="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-blue-600 hover:bg-blue-500 border border-blue-400/40 shadow-lg shadow-blue-900/30 transition"
                            >
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
